...
class AddEditActivity : AppCompatActivity() {
    ...
    private fun getMahasiswaById(id: Long) {
        ...
        val stringRequest: StringRequest = object :
            StringRequest(Method.GET, MahasiswaApi.GET_BY_ID_URL + 1d, Response.Listener { response ->
                val gson = Gson)
                val mahasiswa = gson.fronJson(response,Mahasiswa: :class. Java)

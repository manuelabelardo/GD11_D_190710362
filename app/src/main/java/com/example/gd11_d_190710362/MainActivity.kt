package com.example.gd11_d_190710362
...
import com.example.gd11_d_190710362.MainActivity.Companion.LAUNCH_ADD_ACTIVITY
import com.google.android.material.floatingactionbutton.FloatingActionButton
import com.google.gson.Gson
import com.example.gd11_d_190710362.adapters.MahasiwaAdapter
import com.example.gd11_d_190710362.api.MahasiswaApi
import com.example.gd11_d_190710362.models.Mahasiswa
...
class MainActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = MahasiwaAdapter(ArrayList(),this)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == LAUNCH_ADD_ACTIVITY && resultCode == resultCode) allMahasiswa()
    }
